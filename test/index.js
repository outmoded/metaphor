            ...
            it('describes an image', (done) => {
                ...
                engine.describe('https://www.sideway.com/sideway.png', (description) => {
                    ...
                    expect(description).to.equal({
                        ...
                        preview: '<html><head></head><body><div class=\'metaphor-embed\'><div class=\'metaphor-embed-header\'><div class="metaphor-embed-header-icon-missing"></div><div class="metaphor-embed-header-site">Image</div><a class="metaphor-embed-header-link" href="https://www.sideway.com/sideway.png"><div class="metaphor-embed-header-title">https://www.sideway.com/sideway.png</div></a></div><div class=\'metaphor-embed-body\'><div class="metaphor-embed-body-description"></div><img class="metaphor-embed-body-image" src="https://www.sideway.com/sideway.png"/></div></div></body></html>',
                        sources: ['resource']
                    });
