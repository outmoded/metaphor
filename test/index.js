            ...
            it('describes an image', (done) => {
                ...
                engine.describe('https://www.sideway.com/sideway.png', (description) => {
                    ...
                    expect(description).to.equal({
                        ...
                        preview: '<!DOCTYPE html><html><head></head><body><div class=\'metaphor-embed\'><div class=\'metaphor-embed-header\'><div class="metaphor-embed-header-icon-missing"></div><div class="metaphor-embed-header-site">Image</div><a class="metaphor-embed-header-link" href="https://www.sideway.com/sideway.png"><div class="metaphor-embed-header-title">https://www.sideway.com/sideway.png</div></a></div><div class=\'metaphor-embed-body\'><div class="metaphor-embed-body-description"></div><div class="metaphor-embed-body-image-wrapper"><img class="metaphor-embed-body-image" src="https://www.sideway.com/sideway.png"/></div></div></div></body></html>',
                        sources: ['resource']
                    });
            ...
            it('describes an image (max size)', (done) => {
                ...
                engine.describe('https://www.sideway.com/sideway.png', (description) => {
                    ...
                    expect(description).to.equal({
                        ...
                        preview: '<!DOCTYPE html><html><head></head><body><div class=\'metaphor-embed\'><div class=\'metaphor-embed-header\'><div class="metaphor-embed-header-icon-missing"></div><div class="metaphor-embed-header-site">Image</div><a class="metaphor-embed-header-link" href="https://www.sideway.com/sideway.png"><div class="metaphor-embed-header-title">https://www.sideway.com/sideway.png</div></a></div><div class=\'metaphor-embed-body\'><div class="metaphor-embed-body-description"></div><div class="metaphor-embed-body-image-missing"></div></div></div></body></html>',
                        sources: ['resource']
                    });
            ...
            it('described a YouTube video', (done) => {
                ...
                engine.describe('https://www.youtube.com/watch?v=cWDdd5KKhts', (description) => {
                    ...
                    expect(description).to.equal({
                        ...
                        preview: '<!DOCTYPE html><html><head><title>Cheese Shop Sketch - Monty Python\'s Flying Circus</title></head><body><div class=\'metaphor-embed\'><div class=\'metaphor-embed-header\'><img class="metaphor-embed-header-icon" src="https://s.ytimg.com/yts/img/favicon_32-vfl8NGn4k.png"/><div class="metaphor-embed-header-site">YouTube</div><a class="metaphor-embed-header-link" href="https://www.youtube.com/watch?v=cWDdd5KKhts"><div class="metaphor-embed-header-title">Cheese Shop Sketch - Monty Python\'s Flying Circus</div></a></div><div class=\'metaphor-embed-body\'><div class="metaphor-embed-body-description">Subscribe to the Official Monty Python Channel here - http://smarturl.it/SubscribeToPython Cleese plays an erudite customer attempting to purchase some chees...</div><div class="metaphor-embed-body-image-wrapper"><img class="metaphor-embed-body-image" src="https://i.ytimg.com/vi/cWDdd5KKhts/hqdefault.jpg"/></div></div></div></body></html>'
                    });
